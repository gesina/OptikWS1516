...
\minisec{Wie sieht das im Detail aus?}
...
\begin{gather*}
  ...
  \dd V_2
\end{gather*}
Im \emph{Fernfeld}\index{Dipolfeld!Fernfeld}
...
\begin{enumerate}
\item {Nahfeld}\index{Dipolfeld!Nahfeld} 
  $\propto \dot\vecp \propto \frac{1}{r^2}$
\item {Fernfeld}\index{Dipolfeld!Fernfeld} 
...
\minisec{Ergebnisse im Fernfeld}
\begin{itemize}
...
\minisec{Transparente Materialien} Die Dispersion im sichtbaren Bereich
